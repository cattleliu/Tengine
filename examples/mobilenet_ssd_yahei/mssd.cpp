...
#define DEF_PROTO "models/MobileNetSSDLite_deploy.prototxt"
#define DEF_MODEL "models/MobileNetSSDLite_deploy.caffemodel"
...
void *th_vedio(void *){
    ...
    cv::VideoCapture capture("./test.mp4");    // video
